...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IStorageLibraryChangeReaderTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<IStorageLibraryChangeReader>(), Is.EqualTo(sizeof(IStorageLibraryChangeReader)));
        }
