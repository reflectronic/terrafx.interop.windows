...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IKnownFoldersCameraRollStaticsTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<IKnownFoldersCameraRollStatics>(), Is.EqualTo(sizeof(IKnownFoldersCameraRollStatics)));
        }
