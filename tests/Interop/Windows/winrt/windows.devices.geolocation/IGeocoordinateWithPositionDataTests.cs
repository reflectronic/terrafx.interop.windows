...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IGeocoordinateWithPositionDataTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<IGeocoordinateWithPositionData>(), Is.EqualTo(sizeof(IGeocoordinateWithPositionData)));
        }
